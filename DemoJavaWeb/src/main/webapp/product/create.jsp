            ...
            <form action="http://localhost:8080/products?action=create" method="post">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" id="inputPassword4" name="price" placeholder="Enter price">
                    </div>
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input type="number" class="form-control" id="inputZip" name="quantity" placeholder="Enter Quantity">
                    </div>
                    <div class="form-group col-md-6">
